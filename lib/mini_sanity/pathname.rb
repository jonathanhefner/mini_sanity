class Pathname
  ...
  # and returns the Pathname unmodified.  Raises an exception if the
  # Pathname fails this check.
  #
  # @example
  ...
  # directory, and returns the Pathname unmodified.  Raises an exception
  # if the Pathname fails this check.
  #
  # @example
  ...
  # returns the Pathname unmodified.  Raises an exception if the
  # Pathname fails this check.
  #
  # @example
  ...
  # the Pathname unmodified.  Raises an exception if the Pathname fails
  # this check.
  #
  # @example
